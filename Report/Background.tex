...
2 modes: 
kalibrerings mode, direkte feed and behandlet feed og slidesr
Tracking mode, direkte feed, feed fra overview camera, statestik/grafer
(Bias mode, klikke på punkt i skålen som plotteren til trække myren mode)

Gemme statestik
Data + billedbehandling + tracking i c/c++
Ændring af tracking params
(punkter plotteren skal styre imod eller undgå)
tracking termit/myre markeret med farver (mellem andre termitter)
flytte plotteren sammen med tracking
