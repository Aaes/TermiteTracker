...
The project will not focus on changing the hardware provided by Harvard. The hardware had already been succesfully used in a controlled and very simple environment, and this project focus on improving the software to handle a more complex environment. However quality suggestions to how the hardware can be improved will be suggested if the current hardware is found to be too limited in a new test environment, or if it would improve the results of the developed software.\\
