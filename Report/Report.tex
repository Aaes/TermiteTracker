...
%Tjek liste:
% - Introduction: skriv noget om outcome (TODO)
% - Scope: forklar hvorfor vi kun bruger een plotter 
% - Scope: TODO (noget med testing)
% - Requirements: kort del-konklusion
% - Theory: Rewrite (Kaspers note)
% - Tracking: Del konklusioner
% - Realization: skriv færdigt
% - Communication with plotter: missing coordinates
% - Cameras: fix section XX
% - Moving the camera: skriv
% - GUI: skriv
% - Statistics: skriv
% - Reflection: skriv
% - Evaluation/Testing/Experimentation: skriv
% - Conclusion: skriv
% - Fix appendix?
